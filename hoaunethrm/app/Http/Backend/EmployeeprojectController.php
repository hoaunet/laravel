...
use Auth;
use App\Http\Models\EmployeeprojectModel;
use Form;
use Input;
use Validator;
use URL;
...
class EmployeeprojectController extends BackendController
{
	...
	public function index(){
        ...
        //$clsPaygrade     = new EmployeeprojectModel();
        //$data['companies']    = $clsPaygrade->get_all();   
		return view('backend.paygrade.index',$data);
	}

	public function getRegist(){
        $data =array();
        
		return view('backend.paygrade.regist',$data);
	}
	...
	public function postRegist()
    {
        ...
        if ($validator->fails()) {
            return redirect()->route('backend.paygrade.regist')->withErrors($validator)->withInput();
        }
        ...
        return redirect()->route('backend.paygrade.index');
    }
    ...
    public function getEdit($id)
    {
        ...
        return view('backend.paygrade.edit', $data);
    }
    ...
    public function postEdit($id)
    {
        ...
        $validator      = Validator::make($inputs, $clsskill->Rules(), $clsskill->Messages());
        if ($validator->fails()) {
            return redirect()->route('backend.paygrade.edit', [$id])->withErrors($validator)->withInput();
        }
