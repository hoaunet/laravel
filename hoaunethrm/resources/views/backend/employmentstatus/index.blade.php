 ...
 <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"><button onclick="location.href='{{route('backend.employmentstatus.regist')}}'" class="btn btn-small btn-primary">新しく追加する <i class="fa fa-plus"></i></button></h3>
