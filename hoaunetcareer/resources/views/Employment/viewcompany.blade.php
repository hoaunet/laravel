...
<div class="ctl">
    ...
    <ul class="box_ntd">
        <li class="l"><img src="/images/user/14801.jpg" alt="logo" style="max-width:120px;"></li>
        <li class="r">
            <h1>Hyundai CNS</h1>
            <div>Lầu 5, số 60 Nguyễn Đình Chiểu quận 1</div>
            <div>Điện thoại: 08 6265 3000</div>
        </li>
        <li class="cl"></li>
    </ul>
    ...
    <div class="bgt">
        ...
        <strong><span style="text-transform:none;">Tin Hyundai CNS tuyển dụng<span></span></span></strong>
    </div>      
    <div class="chuc_nang">
    ...
    <div class="box_list_duoi">
        <div class="col1"><input type="checkbox" id="chk_item0" class="case" name="chk_item[]" value="14877"></div>
        <div class="col2">
            <div class="">
                <strong><a class="" href="/nguoi-tim-viec/nhan-vien-phuc-vu-tiec-id14877.html">NHÂN VIÊN PHỤC VỤ TIỆC</a>  </strong>
                <p><a href="/danh-sach-cac-tin-tuyen-dung-ntd14801.html">Hyundai CNS</a></p> 
                <i>(166 lượt xem)</i>
            </div>
        </div>
        ...
        <div class="cl"></div> 
        <input type="hidden" id="tai_khoan0" value="14801">
    </div></span></span> 
    ...
    <table cellpadding="0" cellspacing="0" class="tb_ct">
        <tbody><tr>
            ...
            <td class="col2 pd">Hyundai CNS</td>
        </tr>          
        <tr>
            <td class="col1"><div style="width:165px;">Địa chỉ</div></td>
            <td class="col2 pd">Lầu 5, số 60 Nguyễn Đình Chiểu quận 1</td>
        </tr>              
        <tr>
        ...
        <tr>
            ...
            <td class="col2 pd">08 6265 3000</td>
        </tr>    
        <tr>
            <td class="col1">
                <div style="width:165px;">
                    Giới thiệu
                    <div style="text-align:center;"><img src="/images/user/14801.jpg" alt="logo" style="max-width:120px;"></div>
                    <div style="text-align:center;"></div>
                </div>
            </td>
            <td class="col2 pd lh">nslation<br>  - supporting corporate business trips<br>  - transportation and logistics<br>Human Resources Consulting<br>  - Headhunting, recruitment agency, and dispatching workers<br>Comprehensive management on building<br>  - Facility management such as electrics and boilers in building<br>  - Management on cleaners, hotel room maids, cooks and chefs</td>
        </tr>           
        <tr>
