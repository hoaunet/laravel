...
<head>
  ...
  <title>Chiroro 労務ソリューションシステム</title>
...
<header class="main-header">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Chiroro Admin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 Chiroro Human Resources ＆ General Affairs Services Inc. All Rights Reserved
  </footer>
