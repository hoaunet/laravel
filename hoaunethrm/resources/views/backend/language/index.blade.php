 ...
 <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title"><button onclick="location.href='{{route('backend.client.regist')}}'" class="btn btn-small btn-primary">新しく追加する <i class="fa fa-plus"></i></button></h3>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered table-striped dataTable" id="grid"  >
                  ...
                  <tbody >
                    ...
                    <tr class="{{($row%2==0)?'odd':'even'}}"">
                       ...
                       <td >Programming and Application Development</td> 
                       <td >001, Sample Road,Sample City, USA</td>
                       <td >678-894-1047</td>                     
